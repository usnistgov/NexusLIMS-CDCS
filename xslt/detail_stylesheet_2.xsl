        ...
        <div class="w-100">
            ...
            <style>
                ...
                */
                ...
                #main-column > .row.mt-4 > .col-md-6 {
                  width: 50%;
                  flex: 0 0 50%;
                  max-width: 50%;
                  min-width: 0;
                }
                /* Keep activity preview image + dataset table side by side */
                .aa-content-row {
                  display: flex;
                  flex-wrap: wrap;
                ...
                .aa-content-row > .aa-img-col {
                  flex: 0 0 33.333333%;
                  max-width: 33.333333%;
                  width: 33.333333%;
                }

                .aa-content-row > .aa-table-col {
                  flex: 0 0 66.666667%;
                  max-width: 66.666667%;
                  width: 66.666667%;
                }

                /* Prevent the inner DataTables wrapper from shrinking the table area */
                .aa-table-col .table-row > .table-col,
                .aa-table-col .pager-row > .pager-col {
                  flex: 0 0 100%;
                  max-width: 100%;
                  width: 100%;
                }

                .aa-table-col .aa-table {
                  width: 100% !important;
                }
                .dt_paginate_container {
                  width: 100%;
                }
            ...
            <script language="javascript">
                ...
                document.addEventListener("DOMContentLoaded", function(event) {
                    ...
                    function showSlides(n) {
                        ...
                        if (document.getElementById('img_gallery') != null) {
                            if (slides.length === 0) {
                    ...
                    $(document).ready(function(){
                        ...
                        $('.aa-table').each(function() {
                            var this_table = $(this).DataTable({
                                ...
                                responsive: true,
                                ordering: true,
                                dom: '<"table-row"<"col-xs-12 table-col"t>><"row pager-row"<"col-xs-12 pager-col"p>>'
                            });
